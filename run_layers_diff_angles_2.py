...
z0s1 = 100 * np.arange(-1, 1)
z0s1[-1] = z0s1[-2] + 1000

z0s2 = 300 * np.arange(-1, 1)
z0s2[-1] = z0s2[-2] + 1000

ids = np.tile([0, 1], 1)
# z = ax + by + c
func_5d = lambda x, y: ((0.1 * x) + (0 * y))
func_26d = lambda x, y: ((0.3 * x) + (0 * y))
...
for i in range(n_steps):
    ...
    if i%2000==0:
        ...
        basin_mg1c = basin_mg1
        basin_mg2c = basin_mg2
        ...
        basin_mg1 = basin_mg1c
        basin_mg2 = basin_mg2c
