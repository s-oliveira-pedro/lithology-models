...
for i in range(n_steps):
    ...
    if i%5000==0:
        save_directory = "/Users/poliveira/Library/CloudStorage/OneDrive-CityUniversityofNewYork/PhD_LIFE/PhD_2nd_Chapter/model_low_angle_1"
        ...
        plot_filename = os.path.join(save_directory, "model_low_angle_1_" + str((i + 1) * dt) + "_yrs.png")
        plt.savefig(plot_filename)

        data_filename1 = os.path.join(save_directory, "topo1_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
        data_filename2 = os.path.join(save_directory, "ksp1_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
        data_filename3 = os.path.join(save_directory, "topo2_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
        data_filename4 = os.path.join(save_directory, "ksp2_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
        data_filename5 = os.path.join(save_directory, "topo3_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
        data_filename6 = os.path.join(save_directory, "ksp3_model_low_angle_1_" + str((i + 1) * dt) + " yrs.txt")
