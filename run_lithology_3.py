...
for i in range(n_steps):
    ...
    if i % 1000 == 0:
        save_directory = "/Users/poliveira/Library/CloudStorage/OneDrive-CityUniversityofNewYork/PhD_LIFE/PhD_2nd_Chapter/model_lito_3"
        ...
        # Save the figure
        plot_filename = os.path.join(save_directory, "model_lito_3_" + str((i + 1) * dt) + "_yrs.png")
        ...
        data_filename = os.path.join(save_directory, "model_lito_3_" + str((i + 1) * dt) + " yrs.txt")
